...
target = driver.find_element(By.XPATH ,'//*[@id="rso"]/div[3]/div/div/div/div[1]/div/div/span/a/h3/span')
target.click()
       
full_name_elem = driver.find_element(By.NAME,"name").send_keys("str")
driver.find_element(By.XPATH ,'//*[@id="rso"]/div[3]/div/div/div/div[1]/div/div/span/a/h3/span').click()     